...
<html lang="en">
	...
	<body>
					...
					<div class="row show-grid">
						<div class="col-sm-10 form-horizontal" style="display:inline-block;">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select id="videoRegion">
										<c:forEach items="${videoRegion}" varStatus="i" var="item" >
											<option value="${item.id}">${item.name}</option>
										</c:forEach>
									</select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select id="videoYear">
										<c:forEach items="${videoYear}" varStatus="i" var="item" >
											<option value="${item.id}">${item.name}</option>
										</c:forEach>
									</select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" data-trigger="" data-title="必填" class="form-control" id="actor"
										   data-options="required:true,length:11"
										   data-toggle="popover" data-placement="top"
										   data-content="请输入演员，限10个字"
										   placeholder="演员">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea id="introduction"  class="form-control"     style= "overflow:hidden; resize:none;width:100%;height:80px;" rows="" cols=""></textarea>
								</div>
							</div>		
							<div class="form-group">
		...
		<!-- 加载页面JS -->
		<script src="<%=basePath %>module/resource/videoInfo.js"></script>
	</body>
</html>
