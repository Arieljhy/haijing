...
<html lang="en">
	...
	<body>
		...
		<div class="title1">
					<span>直播管理</span><span>/</span><span class="fh">直播列表</span><span>>></span><span id="ttt"></span>
			</div>
			<div class="title2">
					...
					<div class="row show-grid">
						<div class="col-sm-10 form-horizontal" style="display:inline-block;">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" data-trigger="" name="name" data-title="必填" class="form-control"
										   data-options="required:true,length:11"
										   data-toggle="popover" data-placement="top"
										   data-content="请输入直播主题，限10个字"
										   placeholder="直播主题">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" id="addDate" data-trigger="" name="time" class="form-control" data-title="必填" placeholder="直播时间">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">是否可回看</label>
								<div class="col-sm-8" >
									<label class="radio-inline">
										<input type="radio" name="record"  value="1" > 是
									</label>
									<label class="radio-inline">
										<input type="radio" name="record"  value="0"  data-trigger="" data-title="必填">否
									</label>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" data-trigger="" name="person"  class="form-control" data-title="必填"
										   data-options="required:true,length:11"
										   data-toggle="popover" data-placement="top"
										   data-content="请输入直播人，限10个字"
										   placeholder="直播人">
								</div>
							</div>
						</div>
		...
		<!-- 加载页面JS -->
		<script src="<%=basePath %>module/live/liveInfo.js"></script>
		<script src="<%=basePath %>module/js/pinyin.js"></script>
	</body>
</html>
