...
<html lang="en">
	...
	<body>
					...
					<div class="row show-grid">
						<div class="col-sm-10 form-horizontal" style="display:inline-block;">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="content_title">文章标题</label>
								<div class="col-sm-8">
									<input type="text" data-trigger="" class="form-control" data-title="必填" id="content_title" placeholder="文章标题">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="state">摘要</label>
								<div class="col-sm-8">
									<textarea id="remark" style= "overflow:hidden; resize:none;width:100%;height:80px;" rows="" cols=""></textarea>

								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="state">内容</label>
								<div class="col-sm-8">
									<script id="content" style="height:400px;" name="content" type="text/plain"></script>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- 加载页面JS -->
		<script src="<%=basePath %>module/study/contentInfo.js"></script>
	</body>
</html>
