...
<body>
	<section class="wrapper w1">
		<div class="title1">
					<span>测试管理</span><span>/</span><span  id="mytit"></span><span>>></span><span id="ttt" class="fh">答题情况</span>>><span>查看详情</span>
			</div>
			<div class="title2">
					<div class="left" id="title" >查看详情</div>
					<div class="right">
			...
			<div class="col-lg-12">
				<div class="content-panel" style="height:calc(100% - 79px);">
					...
					<h5 id="remark"></h5>
						...
						<section id="no-more-tables"  style="height:100%;">
						<div class="table-con" style="height:calc(100% - 70px);">
	...
	<script src="<%=basePath %>module/study/userAnserList.js"></script>
</body>
</html>
