...
<html lang="en">
	...
	<body>
		<section class="wrapper w1">
			<div class="title1">
					<span>论坛管理</span><span>/</span><span class="fh">论坛板块管理</span><span>>></span><span id="ttt"></span>
			</div>
			<div class="title2">
					<div class="left" id="title">新增论坛类型</div>
					<div class="right">
					...
					<div class="row show-grid">
						<div class="col-sm-5 form-horizontal" style="display:inline-block;">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="switch" off-label="禁用" on-label="启用" onclick="checkboxOnclick()">
		...
		<!-- 加载页面JS -->
		<script src="<%=basePath %>module/bbs/classfiyInfo.js"></script>
	</body>
</html>
